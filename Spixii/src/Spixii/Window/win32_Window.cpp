...
#include "Spixii/Window/win32_Window.h"
...
namespace Spixii
{
    ...
    Window *Window::Create(Allocator *allocator, const WindowProperties &prop)
    {
        SPX_INFO_CORE("sizeof(Win32Window)={0} alignof(Win32Window)={1}", sizeof(Win32Window), alignof(Win32Window));
        return allocator->makeNew<Win32Window>(prop);
    }
    ...
    bool Win32Window::IsVSyncOn() const
    {
